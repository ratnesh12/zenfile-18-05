...
if(isset($associate['id'])){
    $this -> table -> add_row('Password', form_submit('reset_password','Reset Password'));
}
...
if(isset($associate['is_replaced']) && $associate['is_replaced'] =='0'){
    $this -> table -> add_row('Blocked', form_checkbox('blocked', '1', empty($associate['blocked']) ? '' : $associate['blocked']));
}
