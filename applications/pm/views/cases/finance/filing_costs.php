...
<div id="finance-filing-costs">
    <?php foreach ($invoices as $invoice) { ?>
        <?php
        if ($invoice->is_deadline_passed && $invoice->fa_invoice_status) {
                ...
                <?php foreach($invoice->additional_fees as $additional_fee) { ?>
                    ...
                    <div>
                        ...
                        <div class="finance_input float_left">
                            ...
                            <?php echo $currency_sign ?><input title="<?php echo $additional_fee->additional_fee_description_by_fa ?>" name="additional_fee_corrected_by_pm[]" value="<?php echo $additional_fee_value ?>" type="text"/>
                        </div>
...
<!--                        </div>-->
                ...
                <div>
                    <div class="finance_label float_left">
                        <?php foreach($invoice->invoices as $file) { ?>
                            <a href="<?php echo base_url() ?>cases/download_file/<?php echo $file->file_id ?>"><?php echo $file->filename ?></a>
                        <?php } ?>
                    </div>
                </div>
            </div>
