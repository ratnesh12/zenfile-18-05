...
class Files_model extends CI_Model
{
    ...
    public function file_view_more($file_id){
        $this->db->select('associates.fee_currency, cases_files_data.*');
        $this->db->join('cases_associates_data','cases_files_data.fa_id = cases_associates_data.associate_id');
        $this->db->join('associates','cases_files_data.fa_id = associates.id');
        $this->db->where('visible_to_pm','1');
