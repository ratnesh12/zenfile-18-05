...
// TEST_MODE is an option to send emails to a special list like client@zenfile.com, pm@zenfile.com, fa@zenfile.com
...
|
*/
if(!empty($_SERVER["HTTP_HOST"]) && $_SERVER["HTTP_HOST"]=="zenfile.local")
{
    $config['base_url']	= 'https://zenfile.local/pm/';
}
else
{
    //    $config['base_url']	= 'https://zenfile.com/pm/';
    $config['base_url']	= '';
}
...
$config['email_open'] = '@zenfile.com';
if(!empty($_SERVER["HTTP_HOST"]) && $_SERVER["HTTP_HOST"] == "dev.zenfile.com")
{
    $config['http_path_upload'] = '/srv/www/htdocs/devzen/';
    $config['path_upload'] = '/home/devzen/public_html/';
    $config['email_open'] = '@dev.zenfile.com';
...
$config['smpt_sendmail'] = '0';
if(!empty($_SERVER["HTTP_HOST"]) &&($_SERVER["HTTP_HOST"] == "dev.zenfile.com" || $_SERVER["HTTP_HOST"] == "zenfile.com")){
    $config['smpt_sendmail'] = '1';
}
