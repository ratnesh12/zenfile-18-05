...
<?php /*$globalStylesNew = array(
    // libraries css
    '0' => 'reset.css',
    '1' => 'jquery.selectbox.css',
    '2' => 'msgBoxLight.css',
    '3' => 'fileuploader.css',
    '4' => 'facebox.css',

    // zenfile css
    '5' => 'global.zenfile.css',
    '6' => 'form.zenfile.css',
    '7' => 'flags.zenfile.css',
    '8' => 'files.zenfile.css',
    '9' => 'datepicker.zenfile.css',
    '10' => 'autocomplete.zenfile.css',
    '11' => 'ezmark_checkbox.zenfile.css',
    '12' => 'template.zenfile.css',
    '13' => 'styles.zenfile.css',
	'14' => 'application_form.zenfile.css'
);*/

//for($i=0;$i<count($globalStylesNew);$i++){?>
<?php /*?><link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/<?=$globalStylesNew[$i]?>" /><?php */?>
	
<?	//}
?> 
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/application_form.zenfile.css" />

<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/uploaders.zenfile.js"></script>
<?php /*?><script type="text/javascript" src="<?php echo base_url(); ?>assets/js/application_form.zenfile.js"></script><?php */?>
    ...
    <div class="fieldset step step-current" id="step0">
        ...
        <div class="fieldset step" id="step2">
            ...
            <div class="p">
             <table width="100%" border="0">
                <td><label>Application # <span class="asterisk">*</span></label></td>
                <td><input name="application_number" class="parse_application_activator" type="text" value="<?= $application_number ?>" /></td>
             </table>
        ...
        <div class="fieldset step" id="step3">
            ...
            <div class="p">
             <table width="100%" border="0">
              <tr>
                <td><label>Application title:</label></td>
                <td><input name="application_title" class="application_title_field" type="text" value="<?= $application_title ?>"  /></td>
            </table>
            </div>
            <div class="p">
            <table width="100%" border="0">
             <tr>
                <td><label>Applicant:<span style="display:none;" class="asterisk for_direct">*</span></label></td>
                <td><input name="applicant" class="applicant_field" type="text" value="<?= $applicant ?>" /></td>
             </tr>
             </table>
            </div>
            <div class="p">
            <table width="100%" border="0">
              <tr>
                <td><label>Filing deadline:<span style="display:none;" class="asterisk for_direct">*</span></label></td>
                <td><input title="30 months after first priority date" class="datepicker filing_deadline_field my-tooltip" name="deadline" value="<?= $filing_deadline ?>" type="text" autocomplete="off" readonly="readonly" /></td>
                </tr>
             </table>
            </div>
            <div class="bottom_nav">
        ...
        <div class="fieldset step" id="step4">
            ...
            <div class="p" style="width: 390px;">
                ...
                <table width="100%" border="0">
  <tr>
    <td><label>Case Reference # </label> </td>
    <td><input class="my-tooltip" title="Enter a personal reference number for your own convenience" name="reference_number" type="text" value="<?= $reference_number ?>" /> </td>
  </tr>
</table>
                            ...
                            <div class="additional_contact">
                                ...
                                <table width="100%" border="0">
                                 <tr>
                                    ...
                                    <td><input name="addtional_contacts[]" type="text" value="<?php echo $contact["email"]; ?>" /></td>
                                 </tr>
                                </table>
                                </div>
                            </div>
            ...
            <div class="additional_contact adder">
                ...
                <div class="p">
                 <table width="100%" border="0">
                   <tr>
                       <td><label>Contact</label></td>
                       <td><input name="addtional_contacts[]" type="email" value="" /></td>
                   </tr>
                 </table>
                </div>
                <div class="clear"></div>
...
<?php } ?>
                            ...
                            <div class="fieldset step" id="step10">
                                ...
                                <div class="bottom_nav">
                                 ...
                                 <tr>
                                  <td>
    <a href="#back" class="back" onClick="stanlider.Show('back', 9);" style="height:21px; text-align:center; width:63px;"><span>Back</span></a></td>
                                    <td><button class="next" type="submit" style="width:90px; *border-radius:6px 6px 6px 6px !important; height:35px;"><span>Submit</span></button></td>
                            </tr>
                             </table>
                                    <div class="clear"></div>
                                </div>
